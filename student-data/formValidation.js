...
function updateData(index){
    ...
    document.getElementById("cls").value = peopleList[index].add_class;
    document.getElementById("divi").value = peopleList[index].division;
    document.getElementById("reg").value = peopleList[index].registration;
    document.getElementById("email").value = peopleList[index].Email;
     ...
     document.querySelector("#update").onclick=function(){
        ...
        peopleList[index].add_class = document.getElementById("cls").value
        peopleList[index].division = document.getElementById("divi").value
        peopleList[index].registration = document.getElementById("reg").value
